    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG height="350" src="http://192.168.25.128/${goods.gimage}" jqimg="http://192.168.25.128/${goods.gimage}" width="350">
                </div>
                <div id="spec-n5">
        ...
        <div class="shop_goods_show_right">
            ...
            <script type="text/javascript">
                function addCart(){
                    var gsid = ${goods.id};
                    var goodsnums = $("#good_nums").val();
                    location.href = "http://localhost:8085/cart/addcart?gsid="+gsid+"&goodsnums="+goodsnums;
                }
            </script>
